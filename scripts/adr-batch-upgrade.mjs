...
const ADR_TEMPLATES = {
  'ADR-0006': {
    ...
    'impact-scope': ['src/shared/db/', 'electron/db/', 'scripts/db-migration.mjs'],
  ...
  'ADR-0007': {
    ...
    'tech-tags': ['hexagonal-architecture', 'ports-adapters', 'dependency-injection', 'interfaces'],
    'impact-scope': ['src/ports/', 'src/adapters/', 'src/domain/', 'src/shared/contracts/'],
    'executable-deliverables': [
  ...
  'ADR-0008': {
    ...
    'tech-tags': ['electron-builder', 'github-releases', 'deployment', 'ci-cd', 'auto-update'],
    'impact-scope': ['build/', 'electron-builder.json', '.github/workflows/', 'scripts/release.mjs'],
    'executable-deliverables': [
  ...
  'ADR-0009': {
    ...
    'tech-tags': ['cross-platform', 'windows', 'macos', 'linux', 'compatibility'],
