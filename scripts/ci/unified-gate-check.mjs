...
if (scanResult !== 'success') {
  console.log('[Hard Failure] Static security scan failed, violates ADR-0002 security baseline');
  process.exit(1);
}
if (e2eStatus === 'failed') {
  console.log('[Hard Failure] E2E security tests failed (from aggregated outputs)');
  process.exit(1);
}
console.log('Unified security gate pre-checks passed (static scan + E2E outputs)');
process.exit(0);
