...
if (!feed) { console.error('FEED_FILE is required'); process.exit(1); }
...
const r = spawnSync(process.execPath, ['scripts/release/manage-manifest.mjs', 'validate'], { stdio: 'inherit' });
