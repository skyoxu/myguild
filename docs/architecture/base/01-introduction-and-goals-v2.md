...
```typescript
export type QualityId = 'reliability' | 'perf' | 'event-latency' | 'ux-latency' | 'observability'
...
export const QUALITY_GOALS: QualityGoal[] = [
  { id: 'reliability', title: '可靠性', slos: [{ id: 'CFS', metric: 'crash_free_sessions', target: 0.995, windowHours: 24 }] },
  { id: 'perf', title: '帧率', slos: [{ id: 'FPS', metric: 'fps', target: 60 }] },
  { id: 'event-latency', title: '事件处理时延', slos: [{ id: 'EV_TP95', metric: 'tp95', target: 50 }] },
  { id: 'ux-latency', title: '关键交互时延', slos: [{ id: 'UX_TP95', metric: 'tp95', target: 100 }] },
  { id: 'observability', title: '可观测性', slos: [{ id: 'ERR_COV', metric: 'coverage', target: 0.95 }] }
]
```
